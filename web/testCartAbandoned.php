...
$location = "/patti/web/testCartAbandoned.php";
...
<body>
    <div class="wrapper">
	    <div class="content">
            <div id="page" >
                <div class="title">Abandon Cart</div>
                <hr/>
								<div id='info-img'></div>
								<div id='back'>
									<a href="javascript:void(0)" class="easyui-linkbutton" [plain]="true" iconCls="icon-back" onclick="goBack()" style="width:90px">Back</a>
								</div>
								<div id='info-div'>This Test Simulates a user navigating to the Thrivecart site and selecting a product, Entering their information and Credit Card Number and then abandoning their cart.</div>
	    		</div> <!-- end of page -->
			</div> <!-- end of content -->
			<hr />
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:380px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
			...
			<input type='hidden' name="event" value='cart.abandoned' />
			<input type='hidden' name="base_product" value="24" />
			<input type='hidden' name="base_product_label" value="Zapier Integration Bundle  (monthly)" />
			<div class="fitem">
			<label for="name">Full Name:</label>
			<input class="easyui-textbox" name="viewer[name]" required="true">
			</div>
			<div class="fitem">
			<label for="email">Email:</label>
			<input class="easyui-textbox" name="viewer[email]" required="true">
			</div>
			<div class="fitem">
			<label for="confirm">Checkbox:</label>
			<input class="easyui-checkbox" name="viewer[checkbox_confirmation]" >
			</div>
		</form>
	</div>
	<div id="dlg-buttons">
	    <div id="sql_buttons" class="show-sql">
		<a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-destroy" onclick="abandonCart()" style="width:90px">Abandon</a>
	   </div>
