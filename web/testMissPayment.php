...
<body>
    <div class="wrapper">
	    <div class="content">
            <div id="page" >
                <div class="title">Credit Card Rebill Failed</div>
                <hr/>
								<div id='info-img'></div>
								<div id='back'>
									<a href="javascript:void(0)" class="easyui-linkbutton" [plain]="true" iconCls="icon-back" onclick="goBack()" style="width:90px">Back</a>
								</div>
								<div id='info-div'>This Test Simulates Thrivecart notifying us that a credit card rebill has failed.</div>
	    		</div> <!-- end of page -->
			</div> <!-- end of content -->
			<hr />
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:380px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
			...
			<input type='hidden' name="event" value='order.rebill_failed' />
