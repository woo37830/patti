...
##	  http://yourserver.com/lead-handler.php
##
##	- Make sure that you have created a mailnuggets rule
##	  that posts to http://yourserver.com/lead-handler.php
##
...
if(function_exists('json_decode') && $postedEmail != null)
	{
		...
		echo "postedEmail decoded: $error\n";
	}
...
######################################################
## 	log the processed email to lead-handler-Log.txt
...
$myFile = "lead-handler-Log-$time.txt";
