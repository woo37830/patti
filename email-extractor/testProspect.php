...
$prospect = new Prospect($account, $data);

print "Input: ".$prospect->get_inputStr()."\n\n";
print $prospect;

print "\n---------------------- Prospect with no address -----------------------\n";
$prospect = new Prospect($account, "Ralph McLeod, rmcleod@testers.com, (888) 555-1212");
...
print "\n---------------------- Prospect with no address different phone format -----------------------\n";
$prospect = new Prospect($account, "Ralph O'Toole, rotoole@testers.com, 888.555.1212");

print "Input: ".$prospect->get_inputStr()."\n\n";
print $prospect;

print "\n---------------------- Prospect with complicated address O name and extended zip Code and phone format -----------------------\n";
$prospect = new Prospect($account, "Ralph O'Toole, 16234 90th Street NW Alachua, FL 33050-1234 rotoole@testers.com, 8885551212");

print "Input: ".$prospect->get_inputStr()."\n\n";
print $prospect;

print "\n---------------------- Prospect with leading phone and complicated address and McName -----------------------\n";
$prospect = new Prospect($account, "(888) 555-1212 Ralph McLeod, 16234 90th Street NW Alachua, FL 33050 rmcleod@testers.com");

print "Input: ".$prospect->get_inputStr()."\n\n";
print $prospect;

print "\n---------------------- Prospect with phone before numbered stree address -----------------------\n";
$prospect = new Prospect($account, "(888) 555-1212 106 Crestview Lane Oak Ridge, TN 37830 Ralph Jones charles@testers.com ");
